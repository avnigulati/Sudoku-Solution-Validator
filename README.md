• The objective of this project is to design a multi-threaded application (27 threads) in C language to determine whether the solution to a Sudoku puzzle is valid.
